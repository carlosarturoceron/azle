...
export function bundleFromString(ts: TypeScript): JavaScript {
    ...
    const buildResult = buildSync({
        ...
        alias: {
            ...
            https: join(__dirname, '../polyfills/https.js'),
            ...
            timers: join(__dirname, '../polyfills/timers'),
            util: join(__dirname, '../polyfills/util'),
            vm: join(__dirname, '../polyfills/vm.js'),
            worker_threads: join(__dirname, '../polyfills/worker_threads.js'),
            v8: join(__dirname, '../polyfills/v8.js'),
            assert: join(__dirname, '../polyfills/assert.js'),
            'fs/promises': join(__dirname, '../polyfills/fs/promises.js'),
            ...
            // util: join(__dirname, '../polyfills/internal/util.js')
            // fs: 'memory-fs',
