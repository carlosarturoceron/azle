...
const { BigInt, Float32Array, Float64Array, MathFloor, Number, Uint8Array } =
    primordials;
...
const {
    privateSymbols: { untransferable_object_private_symbol }
...
function addBufferPrototypeMethods(proto) {
    ...
    proto.writeDoubleLE = bigEndian
        ? writeDoubleBackwards
        : writeDoubleForwards;
    proto.writeDoubleBE = bigEndian
        ? writeDoubleForwards
        : writeDoubleBackwards;
