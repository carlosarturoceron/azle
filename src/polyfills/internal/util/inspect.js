...
function markCwd(ctx, line, workingDirectory) {
    ...
    if (cwdStartPos !== -1) {
        if (
            StringPrototypeSlice(line, cwdStartPos - 7, cwdStartPos) ===
            'file://'
        ) {
            cwdLength += 7;
            cwdStartPos -= 7;
        ...
        const cwdSlice = StringPrototypeSlice(
            line,
            start,
            ...
            for (let line of lines) {
                ...
                if (core !== null && BuiltinModule.exists(core[1])) {
                    ...
                    if (workingDirectory !== undefined) {
                        ...
                        if (newLine === line) {
                            esmWorkingDirectory ??=
                                pathToFileUrlHref(workingDirectory);
