...
ObjectSetPrototypeOf(
    InternalTransferredWritableStream.prototype,
...
class WritableStreamDefaultWriter {
    ...
    get closed() {
        if (!isWritableStreamDefaultWriter(this))
            return PromiseReject(
                new ERR_INVALID_THIS('WritableStreamDefaultWriter')
            );
...
ObjectDefineProperties(WritableStreamDefaultWriter.prototype, {
    ...
    [SymbolToStringTag]: getNonWritablePropertyDescriptor(
        WritableStreamDefaultWriter.name
    )
});
