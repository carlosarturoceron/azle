        ...
        watchFile(
            ...
            (currentStats, previousStats) => {
                if (
                    ...
                    currentStats.nlink !== 0 &&
                    existingStat.mtimeMs === currentStats.mtimeMs
                ) {
                    return;
                }
                ...
                if (
                    currentStats.birthtimeMs === 0 &&
                    previousStats.birthtimeMs !== 0
                ) {
                    ...
                    this.emit(
                        'change',
                        'rename',
                        pathRelative(this.#rootPath, file)
                    );
