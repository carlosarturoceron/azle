...
StatWatcher.prototype[kFSStatWatcherStart] = function (
    filename,
    persistent,
    interval
) {
...
FSWatcher.prototype[kFSWatchStart] = function (
    ...
    const err = this._handle.start(
        toNamespacedPath(filename),
        persistent,
        recursive,
        encoding
    );
