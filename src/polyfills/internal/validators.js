...
const validateObject = hideStackFrames(
    (value, name, options = kValidateObjectNone) => {
        if (options === kValidateObjectNone) {
            ...
            const throwOnNullable =
                (kValidateObjectAllowNullable & options) === 0;
            ...
            const throwOnFunction =
                (kValidateObjectAllowFunction & options) === 0;
 ...
 * @returns {number}
 */
const validatePort = hideStackFrames(
