...
const {
    codes: { ERR_NO_CRYPTO, ERR_UNKNOWN_SIGNAL },
...
const {
    ...
    privateSymbols: { arrow_message_private_symbol, decorated_private_symbol },
    sleep: _sleep
...
function isInsideNodeModules() {
    ...
    if (ArrayIsArray(stack)) {
        for (const frame of stack) {
            ...
            if (RegExpPrototypeExec(/^\/|\\/, filename) === null) continue;
